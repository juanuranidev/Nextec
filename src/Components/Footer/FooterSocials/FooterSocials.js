  ...
  return (
    <div className='footerSocials'>
      ...
      <div className='footerSocials_div'>
        ...
        <a href='https://www.instagram.com/therock/' target='_blank' className='footerSocials_div_a fab fa-instagram fa-3x' />
        <a href='https://twitter.com/elonmusk' target='_blank' className='footerSocials_div_a fab fa-twitter fa-3x' />
      </div>
    </div>
  );
};
